...
export const TRAINING_SEED_DATA = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Four Main Tabs', content: 'The Financials page has four tabs: POS (Point of Sale for the register, record purchases, redeem passes, overdue payments, failed payments, and refunds), Transactions (a live feed of recent payments and daily summary), Subscriptions (member billing), and Invoices (payment history).' },
      ...
      { title: 'Transactions Tab', content: 'The Transactions tab shows a live feed of all recent payments (member name, amount, type, and timestamp) plus a daily summary broken down by payment type: guest fees, overage fees, merchandise, membership payments, cash collected, check payments, and other.' },
