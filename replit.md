...
- **Add Member Workflow**: When staff add a new member, a "Next Steps" flow appears with options to send a payment link or copy the email for Quick Charge in the Financials tab.
