...
## Recent Changes
- **v7.31.2 (2026-02-10)**: Post-Refactor Code Cleanup — removed 7 orphaned component files (~1,744 lines dead code), consolidated duplicate PlayerSlot type to single source of truth, removed 9 unused imports across 5 files, cleaned up unused exports from shared utilities.
