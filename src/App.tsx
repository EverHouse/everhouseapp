...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const headerContent = showHeader ? (
    <header className={`fixed -top-[120px] left-0 right-0 flex items-center px-4 sm:px-6 pt-[calc(120px+max(16px,env(safe-area-inset-top)))] pb-4 pointer-events-auto transition-[box-shadow,border-color] duration-300 ${headerClasses}`} style={{ zIndex: 'var(--z-header)' }} role="banner">
