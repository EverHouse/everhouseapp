...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const headerContent = showHeader ? (
    <header className={`fixed top-0 left-0 right-0 flex items-center px-4 sm:px-6 pt-[max(16px,env(safe-area-inset-top))] pb-4 pointer-events-auto transition-[box-shadow,border-color] duration-300 ${headerClasses}`} style={{ zIndex: 'var(--z-header)', backgroundColor: 'transparent', backgroundImage: 'linear-gradient(#293515, #293515)' }} role="banner">
