...
const Dashboard: React.FC = () => {
  ...
  // Use a stable reference for the current time to avoid redundant re-renders/re-calculations
  // Updates every 60 seconds to keep "upcoming" logic accurate
  ...
  const todayStr = useMemo(() => getTodayString(), [nowTime]);
