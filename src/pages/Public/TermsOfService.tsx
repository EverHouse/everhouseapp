  ...
  return (
    <div className="min-h-screen bg-[#F2F2EC] dark:bg-[#0f120a] text-[#293515] dark:text-[#F2F2EC] pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <p className="text-sm opacity-60 mb-12">Effective Date: {new Date().toLocaleDateString()}</p>

        <div className="space-y-8 leading-relaxed font-sans text-lg">
          <section>
            <h2 className="text-2xl font-display mb-4">1. Agreement Overview</h2>
            <p>
              This Membership Agreement ("Agreement") outlines the terms and conditions of membership at Ever House (the "Club"). By becoming an Ever House member (or guest of a member), you agree to abide by this Agreement and all Club rules. This Agreement is intended to protect our members, guests, and the Club.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Cancellation:</strong> If you do not wish to renew, you must provide Ever House written notice at least 30 days before your term ends. You may cancel at the end of your current annual term with no penalty by giving this advance notice. Initiation fees are non-refundable.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Membership dues are payable in advance (monthly or annually). By providing your payment information, you authorize Ever House to charge your designated payment method for all dues, fees, and house charges incurred.
            </p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section className="bg-white/50 dark:bg-white/5 p-6 rounded-xl border border-[#293515]/10 dark:border-white/10">
            ...
            <p className="mb-4">
              To the maximum extent allowed by law, you release Ever House, its owners, partners, employees, and agents from any and all liability or claims for property damage, personal injury, illness, or death arising out of or relating to your membership or presence at the Club.
            </p>
            <p className="mb-4">
          ...
          <section>
            ...
            <p>
              Ever House reserves the right to modify these terms and conditions at any time. Members will be notified of material changes via email or through the member portal. Continued use of Club facilities after such changes constitutes acceptance of the modified terms.
            </p>
          </section>
