      ...
      <div className="px-6 space-y-3 pb-8 flex-1 animate-pop-in" style={{ animationDelay: '0.15s' }}>
        {isLoading ? (
          ...
          <div className="text-center py-20">
            <span className="material-symbols-outlined text-5xl text-primary/30 mb-4">restaurant_menu</span>
            <p className="text-primary/60">Menu items are being updated.</p>
            <p className="text-primary/40 text-sm mt-2">Check back soon for our latest offerings.</p>
          </div>
        ) : (
