    ...
    return (
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-[400px_1fr] xl:grid-cols-[450px_1fr] lg:items-start flex-1">
                    <div className={`lg:border-r border-gray-200 dark:border-white/25 relative lg:flex lg:flex-col lg:max-h-[calc(100vh-180px)] lg:sticky lg:top-4 ${activeView === 'requests' ? 'block' : 'hidden lg:block'}`}>
                        ...
                        <div className="space-y-6 p-5 animate-slide-up-stagger lg:overflow-y-auto lg:flex-1" style={{ '--stagger-index': 0 } as React.CSSProperties}>
