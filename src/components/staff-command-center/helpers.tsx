...
export const GlassListRow: React.FC<{ 
  ...
  <div 
    onClick={onClick}
    style={style}
    className={`flex items-center gap-3 py-3 px-4 -mx-4 hover:bg-primary/[0.06] dark:hover:bg-white/[0.08] transition-colors cursor-pointer border-b border-primary/[0.06] dark:border-white/[0.06] last:border-b-0 ${className}`}
